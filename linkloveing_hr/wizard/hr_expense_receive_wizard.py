...
class HrExpenseReceiveWizard(models.TransientModel):
    _name = "hr.expense.receive.wizard"
    _description = "Hr Expense receive Payment wizard"

    @api.model
    def _default_sheet_id(self):
        context = dict(self._context or {})
        active_ids = context.get('active_ids', [])
        payment = self.env['hr.expense.sheet'].browse(active_ids)
        return payment.id
