...
// -----------------------------------------------------------------------------
    ...
    var SaleChatterComposer = composer.BasicComposer.extend({
        template: 'sale.mail.chatter.ChatComposer',
...
// -----------------------------------------------------------------------------
    var Chatter = form_common.AbstractField.extend({
        template: 'mail.Chatters',

        events: {
            "click .o_chatter_button_new_message": "on_open_composer_new_message",
            "click .o_chatter_button_new_message_sale": "on_open_composer_new_message_sale",
        ...
        on_open_composer_new_message_sale: function () {
            this.open_composer_sale();
        },
        ...
        open_composer_sale: function (options) {
            var self = this;
            var old_composer = this.composer;
            // create the new composer
            this.composer = new SaleChatterComposer(this, this.thread_dataset, {
