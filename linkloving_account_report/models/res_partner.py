...
class ResPartner(models.Model):
    ...
    def _compute_payable_amount(self):
        for res in self:
            ...
            res.payable_amount = sum(order.shipped_amount for order in orders)
    ...
    payable_amount = fields.Float(string=u'已收货未对账金额', compute=_compute_payable_amount)
    ...
    def _compute_pre_payment_amount(self):
        pass

    pre_payment_amount = fields.Float(string=u'预付款金额', compute=_compute_pre_payment_amount)
