odoo.define('sale.Chatters', function (require) {
    "use strict";
    ...
    var mail_chatter_sale = require('mail.Chatter');
    ...
    // var ChatterComposer_sale = mail_chatter_sale.ChatterComposer.include({
...
// -----------------------------------------------------------------------------
    var Chatter_Sale = form_common.AbstractField.extend({
        template: 'sale.mail.Chatter',
    ...
    core.form_widget_registry.add('sale_threads', Chatter_Sale);
    return Chatter_Sale;
