odoo.define('linkloving_product_query.product_query', function (require) {
    "use strict";
...
// if true, the 'Import', 'Export', etc... buttons will be shown
    ...
    ListView.include({
        ...
        render_buttons: function () {
            ...
            if (add_button) {
                ...
                this.$buttons.find(".o_button_query").prop('disabled', true);
            }
        },
    ...
    // var DataQuery = Widget.extend(ControlPanelMixin, {
    //     template: 'ImportView',
    //     opts: [
    ...
    //             .prop('disabled', true);
    //         if (!this.$('input.oe_import_file').val()) {
