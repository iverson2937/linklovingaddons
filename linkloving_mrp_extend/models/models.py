...
class MrpProductionExtend(models.Model):
    ...
    #     ('confirmed', 'Confirmed'),
    #     ('waiting_material',u'等待领料'),
    #     # ('already_picking', u'已领料，生产中'),
    #     ('planned', 'Planned'),
    ...
    #     return self._show_picking_view()
    # def button_already_picking(self):
    #     # self.write({'state': 'progress'})
    #     return self._show_picking_view()
    #
    # def _show_picking_view(self):
...
class ReturnOfMaterial(models.TransientModel):
    ...
    #     'stock.location', 'Scrap Location', default=_get_default_return_location_id,domain="[('usage', '=', 'internal')]",
    #     states={'done': [('readonly', True)]})
